    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        for (let instanceIndex = 0; instanceIndex < producerCount; instanceIndex++) {
            const instanceProducer = new ec2.Instance(this, `ShastaCdkEc2InstanceProducer${instanceIndex}`, {
                ...
                machineImage,
                securityGroup,
                keyPair: ec2.KeyPair.fromKeyPairName(this, `ProducerKeyPair${instanceIndex}`, ShastaCdkStackL2.keyName),
                role,
                blockDevices: [{
                    deviceName: '/dev/xvda',
        ...
        for (let instanceIndex = 0; instanceIndex < consumerCount; instanceIndex++) {
            const instanceConsumer = new ec2.Instance(this, `ShastaCdkEc2InstanceConsumer${instanceIndex}`, {
                ...
                machineImage,
                securityGroup,
                keyPair: ec2.KeyPair.fromKeyPairName(this, `ConsumerKeyPair${instanceIndex}`, ShastaCdkStackL2.keyName),
                role,
                blockDevices: [{
                    deviceName: '/dev/xvda',
                    volume: ec2.BlockDeviceVolume.ebs(64)
        ...
        const producerAsg = new autoscaling.AutoScalingGroup(this, 'ProducerASG', {
            ...
            machineImage,
            securityGroup,
            keyPair: ec2.KeyPair.fromKeyPairName(this, 'ProducerASGKeyPair', ShastaCdkStackL2.keyName),
            role,
            minCapacity: 0,
            desiredCapacity: 0,
            maxCapacity: 128,
        ...
        const consumerAsg = new autoscaling.AutoScalingGroup(this, 'ConsumerASG', {
            ...
            machineImage,
            securityGroup,
            keyPair: ec2.KeyPair.fromKeyPairName(this, 'ConsumerASGKeyPair', ShastaCdkStackL2.keyName),
            role,
            minCapacity: 0,
            desiredCapacity: 0,
            maxCapacity: 8,
